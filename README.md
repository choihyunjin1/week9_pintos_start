...
Pintos `PROJECT 1: Threads`를 처음 시작한다면 먼저 아래 문서를 읽어주세요.

- [개념학습과 테스트기반 구현 가이드.md](./개념학습과%20테스트기반%20구현%20가이드.md)
- [테스트별 한글 수도코드.md](./테스트별%20한글%20수도코드.md)
- [학습가이드 로드맵.md](./학습가이드%20로드맵.md)

이 문서들에는 아래 내용이 나뉘어 정리되어 있습니다.

- `개념학습과 테스트기반 구현 가이드.md`
  - 이번 주에 무엇을 배우는지
  - 이 과제에서 가장 중요한 3가지
  - 테스트를 백준 문제처럼 푸는 관점
  - What / Why / 한글 수도코드 기반 구현 가이드
- `테스트별 한글 수도코드.md`
  - 실제 테스트 이름별 하위 수도코드
  - 어느 파일과 어느 함수부터 봐야 하는지
  - 테스트별 흔한 실패 원인
- `학습가이드 로드맵.md`
  - 요일별 학습 순서
  - 실제 Pintos 테스트 이름 기준 체크리스트
  - 파일명 기준 작업 지도
  - GitHub Project 9 기준 체크리스트
  - PR 리뷰용 템플릿
